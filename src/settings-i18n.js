...
(function initSettingsI18n(root) {
  const STRINGS = {
    en: {
      ...
      sidebarDiscord: "Discord",
      discordTitle: "Discord",
      discordSubtabPresence: "Rich Presence",
      discordSubtabApproval: "Approval",
      ...
      sidebarDiscordApproval: "Discord Approval",
      discordApprovalTitle: "Discord Approval",
      discordApprovalSubtitle: "Approve or deny local permission prompts from Discord. The desktop bubble stays the fallback; whichever surface answers first wins.",
      discordApprovalNoteHtml: "Bring your own bot: create one in the [Discord Developer Portal](https://discord.com/developers/applications) and paste its token below. The token is stored outside the repo and never leaves this machine. Action details on the card are redacted.",
      discordApprovalTokenSectionTitle: "Bot token",
      discordApprovalTokenLabel: "Bot token",
      discordApprovalTokenHintHtml: "In the [Discord Developer Portal](https://discord.com/developers/applications), open your app → Bot → Reset/Copy Token. No privileged intents are needed.",
      discordApprovalTokenPlaceholder: "Paste the bot token",
      discordApprovalReplaceToken: "Paste a new token to replace",
      discordApprovalSaveToken: "Save token",
      discordApprovalSaving: "Saving…",
      discordApprovalTokenSavedPrefix: "Saved:",
      discordApprovalInvalidToken: "That doesn't look like a Discord bot token.",
      discordApprovalTokenSaved: "Discord bot token saved.",
      discordApprovalIdsSectionTitle: "Owner & channel",
      discordApprovalOwnerLabel: "Your Discord user ID",
      discordApprovalOwnerHint: "Enable Developer Mode (Settings → Advanced), then right-click your name → Copy User ID. Only this user can approve.",
      discordApprovalOwnerPlaceholder: "e.g. 123456789012345678",
      discordApprovalChannelLabel: "Fallback channel ID (optional)",
      discordApprovalChannelHint: "Used only if your DMs are closed. Right-click a private channel → Copy Channel ID.",
      discordApprovalChannelPlaceholder: "e.g. 123456789012345678",
      discordApprovalSaveIds: "Save",
      discordApprovalInvalidOwner: "User ID must be a 17–20 digit number.",
      discordApprovalInvalidChannel: "Channel ID must be a 17–20 digit number.",
      discordApprovalConfigSaved: "Discord approval settings saved.",
      discordApprovalActivitySectionTitle: "Activity",
      discordApprovalEnableLabel: "Enable Discord approval",
      discordApprovalEnableDesc: "Send permission cards to Discord while Clawd is running.",
      discordApprovalEnableNeedsConfig: "Save a bot token and your user ID above to enable.",
      discordApprovalTestLabel: "Send a test card",
      discordApprovalTestDesc: "Posts a one-off approval card to confirm delivery. Not tied to any agent request.",
      discordApprovalTestButton: "Send test",
      discordApprovalTesting: "Sending…",
      discordApprovalTestOk: "Test card sent — tap a button in Discord.",
      discordApprovalTestFailed: "Discord test failed.",
      ...
      mobileApprovalsToggle: "Mobile approvals",
      mobileApprovalsToggleDesc: "Let paired phones approve or deny tool requests (allow / deny / suggestion). Off keeps the phone read-only.",
      mobileTranscriptToggle: "Live transcript on phone",
      mobileTranscriptToggleDesc: "Stream the Claude Code conversation to allowed devices. Requires HTTPS or loopback.",
      mobileTranscriptOutputToggle: "Include tool output",
      mobileTranscriptOutputToggleDesc: "Also send tool results in the transcript. Off sends names and metadata only.",
      mobileConnModeTitle: "Connection mode",
      mobileConnModeDesc: "How the phone reaches this desktop. LAN uses your local network; Tailscale routes over your tailnet.",
      mobileConnModeLan: "LAN (same network)",
      mobileConnModeTailscale: "Tailscale",
      mobilePortTitle: "HTTP port",
      mobilePortDesc: "Fixed port for the LAN monitor bridge. Keep it stable so the phone always reconnects.",
      mobileHttpsPortTitle: "HTTPS port",
      mobileHttpsPortDesc: "Fixed port for the secure (wss) bridge the iPhone app installs against. Changing it requires re-pairing the phone.",
      mobilePortInvalid: "Enter a port between 1024 and 65535.",
      mobilePortBindError: "Port in use",
      mobileHttpsToggle: "Secure (HTTPS / wss)",
      mobileHttpsToggleDesc: "Mint a self-signed certificate so iOS gets a secure context for Web Push and approvals. Required for the interactive features on iPhone.",
      mobileHttpsStarting: "Setting up the certificate…",
      mobileHttpsError: "HTTPS setup failed",
      mobileCertSection: "Certificate trust",
      mobileCertDownload: "Download CA certificate",
      mobileCertInstructions: "On your iPhone, open this URL to download the certificate, then install and trust it: Settings → General → VPN & Device Management (install profile), then Settings → General → About → Certificate Trust Settings (turn it on). Secure connections (wss) won't work until the CA is trusted.",
      mobileCertCaFingerprint: "CA fingerprint",
      mobileCertLeafFingerprint: "Server fingerprint",
      mobileCertTrustedToggle: "I have trusted the certificate on my phone",
      mobileCertTrustedDesc: "Bookkeeping only — flip this once you've installed and trusted the CA so you remember it's done.",
      mobilePairTitle: "Pair a phone",
      mobilePairCodeInstructions: "On your phone, open the Clawd app from the Home Screen → Settings → Pair, then type this code.",
      mobilePairCodeHint: "The code refreshes every 10 minutes and after 5 wrong tries.",
      mobilePairNewCode: "New code",
      mobilePairCodeLoading: "Loading code…",
      mobilePairCodeError: "Couldn't load the pairing code.",
      mobileInstallTitle: "Install or Connect",
      mobilePermsTitle: "Phone permissions",
      mobileAdvancedTitle: "Connection & security",
      mobileAdvancedDesc: "Connection mode, ports, HTTPS certificate, and access token.",
      mobileConnDetailsTitle: "Connection details",
      mobilePairShowQr: "Show QR",
      mobilePairHideQr: "Hide QR",
      mobilePairLoadingQr: "Generating QR…",
      mobilePairQrError: "Couldn't generate the QR.",
      mobilePairHostLabel: "Scan this (uses clawd.local)",
      mobilePairIpLabel: "Fallback: raw IP (if clawd.local doesn't resolve)",
      mobilePairHint: "Scan with your phone's camera to open the app, then Add to Home Screen. Pair with the code above — you only enter it once.",
      mobileDevicesTitle: "Paired devices",
      mobileDevicesEmpty: "No devices paired yet. Enter the code above on your phone to pair.",
      mobileDevicesLoading: "Loading devices…",
      mobileDevicesError: "Unable to load paired devices.",
      mobileDeviceLastSeen: "Last seen {time}",
      mobileDeviceNeverSeen: "Never connected",
      mobileDeviceAllowApprovals: "Allow approvals",
      mobileDeviceAllowTranscript: "Allow transcript",
      mobileDeviceRevoke: "Revoke",
      mobileDeviceRevokeConfirm: "Revoke this device? It will be disconnected and must re-pair to reconnect.",
      mobilePushTitle: "Push notifications",
      mobilePushConfigured: "Web Push is configured.",
      mobilePushNotConfigured: "Web Push is not configured yet. Enable Secure (HTTPS) or Mobile approvals to set up push keys.",
      mobilePushSubCount: "{count} active subscription(s)",
      mobilePushError: "Unable to load push status.",
    ...
    zh: {
      ...
      sidebarDiscord: "Discord",
      discordTitle: "Discord",
      discordSubtabPresence: "丰富状态",
      discordSubtabApproval: "审批",
      sidebarDiscordPresence: "Discord 状态",
      discordPresenceTitle: "Discord 丰富状态",
      discordPresenceSubtitle: "在你的 Discord 个人资料上显示当前的智能体和粗略状态。只读、默认关闭——仅共享智能体类型和粗略状态（空闲 / 思考 / 工作 / 等待）。",
      ...
      discordPresenceEnableDesc: "在 Clawd 运行时将智能体状态推送到 Discord。",
      ...
      sidebarDiscordApproval: "Discord 审批",
      discordApprovalTitle: "Discord 审批",
      discordApprovalSubtitle: "从 Discord 批准或拒绝本地权限请求。桌面气泡仍是兜底；哪个先响应就以哪个为准。",
      discordApprovalNoteHtml: "自带机器人：在 [Discord 开发者门户](https://discord.com/developers/applications) 创建一个机器人，并在下方粘贴它的令牌。令牌保存在仓库之外，绝不离开本机。卡片上的操作详情会被脱敏。",
      discordApprovalTokenSectionTitle: "机器人令牌",
      discordApprovalTokenLabel: "机器人令牌",
      discordApprovalTokenHintHtml: "在 [Discord 开发者门户](https://discord.com/developers/applications) 打开你的应用 → Bot → Reset/Copy Token。无需任何特权 Intent。",
      discordApprovalTokenPlaceholder: "粘贴机器人令牌",
      discordApprovalReplaceToken: "粘贴新令牌以替换",
      discordApprovalSaveToken: "保存令牌",
      discordApprovalSaving: "保存中…",
      discordApprovalTokenSavedPrefix: "已保存：",
      discordApprovalInvalidToken: "这看起来不是有效的 Discord 机器人令牌。",
      discordApprovalTokenSaved: "Discord 机器人令牌已保存。",
      discordApprovalIdsSectionTitle: "所有者与频道",
      discordApprovalOwnerLabel: "你的 Discord 用户 ID",
      discordApprovalOwnerHint: "开启开发者模式（设置 → 高级），然后右键你的名字 → 复制用户 ID。只有该用户可以审批。",
      discordApprovalOwnerPlaceholder: "例如 123456789012345678",
      discordApprovalChannelLabel: "兜底频道 ID（可选）",
      discordApprovalChannelHint: "仅当你的私信关闭时使用。右键一个私有频道 → 复制频道 ID。",
      discordApprovalChannelPlaceholder: "例如 123456789012345678",
      discordApprovalSaveIds: "保存",
      discordApprovalInvalidOwner: "用户 ID 必须是 17–20 位数字。",
      discordApprovalInvalidChannel: "频道 ID 必须是 17–20 位数字。",
      discordApprovalConfigSaved: "Discord 审批设置已保存。",
      discordApprovalActivitySectionTitle: "活动",
      discordApprovalEnableLabel: "启用 Discord 审批",
      discordApprovalEnableDesc: "在 Clawd 运行时将权限卡片发送到 Discord。",
      discordApprovalEnableNeedsConfig: "请先在上方保存机器人令牌和你的用户 ID 以启用。",
      discordApprovalTestLabel: "发送测试卡片",
      discordApprovalTestDesc: "发送一张一次性审批卡片以确认送达。与任何代理请求无关。",
      discordApprovalTestButton: "发送测试",
      discordApprovalTesting: "发送中…",
      discordApprovalTestOk: "测试卡片已发送——请在 Discord 中点按一个按钮。",
      discordApprovalTestFailed: "Discord 测试失败。",
      ...
      mobileApprovalsToggle: "移动端审批",
      mobileApprovalsToggleDesc: "允许已配对的手机批准或拒绝工具请求（允许 / 拒绝 / 建议）。关闭时手机保持只读。",
      mobileTranscriptToggle: "手机实时转录",
      mobileTranscriptToggleDesc: "将 Claude Code 对话流式传输到已授权的设备。需要 HTTPS 或回环连接。",
      mobileTranscriptOutputToggle: "包含工具输出",
      mobileTranscriptOutputToggleDesc: "同时在转录中发送工具结果。关闭时仅发送名称和元数据。",
      mobileConnModeTitle: "连接方式",
      mobileConnModeDesc: "手机如何连接到此桌面。局域网使用本地网络；Tailscale 通过你的 tailnet 路由。",
      mobileConnModeLan: "局域网（同一网络）",
      mobileConnModeTailscale: "Tailscale",
      mobilePortTitle: "HTTP 端口",
      mobilePortDesc: "局域网监控桥接的固定端口。保持不变，手机才能始终自动重连。",
      mobileHttpsPortTitle: "HTTPS 端口",
      mobileHttpsPortDesc: "iPhone 应用安装所用的安全（wss）桥接固定端口。更改后需要重新配对手机。",
      mobilePortInvalid: "请输入 1024 到 65535 之间的端口。",
      mobilePortBindError: "端口被占用",
      mobileHttpsToggle: "安全连接（HTTPS / wss）",
      mobileHttpsToggleDesc: "生成自签名证书，让 iOS 获得安全上下文以支持 Web Push 和审批。iPhone 上的交互功能需要此项。",
      mobileHttpsStarting: "正在配置证书…",
      mobileHttpsError: "HTTPS 设置失败",
      mobileCertSection: "证书信任",
      mobileCertDownload: "下载 CA 证书",
      mobileCertInstructions: "在 iPhone 上打开此网址下载证书，然后安装并信任它：设置 → 通用 → VPN 与设备管理（安装描述文件），再到 设置 → 通用 → 关于本机 → 证书信任设置（开启）。在信任 CA 之前安全连接（wss）无法使用。",
      mobileCertCaFingerprint: "CA 指纹",
      mobileCertLeafFingerprint: "服务器指纹",
      mobileCertTrustedToggle: "我已在手机上信任该证书",
      mobileCertTrustedDesc: "仅作记录——安装并信任 CA 后打开此项以便记住已完成。",
      mobilePairTitle: "配对手机",
      mobilePairCodeInstructions: "在手机上从主屏幕打开 Clawd 应用 → 设置 → 配对，然后输入此配对码。",
      mobilePairCodeHint: "配对码每 10 分钟刷新一次，输入错误 5 次后也会刷新。",
      mobilePairNewCode: "换一个码",
      mobilePairCodeLoading: "正在加载配对码…",
      mobilePairCodeError: "无法加载配对码。",
      mobileInstallTitle: "安装或连接",
      mobilePermsTitle: "手机权限",
      mobileAdvancedTitle: "连接与安全",
      mobileAdvancedDesc: "连接方式、端口、HTTPS 证书和访问令牌。",
      mobileConnDetailsTitle: "连接详情",
      mobilePairShowQr: "显示二维码",
      mobilePairHideQr: "隐藏二维码",
      mobilePairLoadingQr: "正在生成二维码…",
      mobilePairQrError: "无法生成二维码。",
      mobilePairHostLabel: "扫描此码（使用 clawd.local）",
      mobilePairIpLabel: "备用：原始 IP（当 clawd.local 无法解析时）",
      mobilePairHint: "用手机相机扫描以打开应用，然后添加到主屏幕。再用上方的配对码配对——只需输入一次。",
      mobileDevicesTitle: "已配对设备",
      mobileDevicesEmpty: "尚未配对设备。在手机上输入上方的配对码即可配对。",
      mobileDevicesLoading: "正在加载设备…",
      mobileDevicesError: "无法加载已配对设备。",
      mobileDeviceLastSeen: "上次连接 {time}",
      mobileDeviceNeverSeen: "从未连接",
      mobileDeviceAllowApprovals: "允许审批",
      mobileDeviceAllowTranscript: "允许转录",
      mobileDeviceRevoke: "撤销",
      mobileDeviceRevokeConfirm: "撤销此设备？它将被断开，需要重新配对才能再次连接。",
      mobilePushTitle: "推送通知",
      mobilePushConfigured: "Web Push 已配置。",
      mobilePushNotConfigured: "Web Push 尚未配置。启用安全连接（HTTPS）或移动端审批以设置推送密钥。",
      mobilePushSubCount: "{count} 个有效订阅",
      mobilePushError: "无法加载推送状态。",
      aboutEasterEggToast: "\u{1F980} Coding shouldn't feel lonely. — Ruller_Lulu / \u9e7f\u9e7f",
    ...
    "zh-TW": {
      ...
      sidebarDiscord: "Discord",
      discordTitle: "Discord",
      discordSubtabPresence: "豐富狀態",
      discordSubtabApproval: "核准",
      sidebarDiscordPresence: "Discord 狀態",
      discordPresenceTitle: "Discord 豐富狀態",
      discordPresenceSubtitle: "在你的 Discord 個人檔案上顯示目前的代理程式與粗略狀態。唯讀、預設關閉——僅分享代理程式類型與粗略狀態（閒置 / 思考 / 工作 / 等待）。",
      ...
      discordPresenceEnableDesc: "在 Clawd 執行時將代理程式狀態推送到 Discord。",
      ...
      sidebarDiscordApproval: "Discord 核准",
      discordApprovalTitle: "Discord 核准",
      discordApprovalSubtitle: "從 Discord 核准或拒絕本機權限請求。桌面氣泡仍是備援；哪個先回應就以哪個為準。",
      discordApprovalNoteHtml: "自備機器人：在 [Discord 開發者入口網站](https://discord.com/developers/applications) 建立一個機器人，並在下方貼上它的權杖。權杖儲存在儲存庫之外，絕不離開本機。卡片上的操作詳情會被遮蔽。",
      discordApprovalTokenSectionTitle: "機器人權杖",
      discordApprovalTokenLabel: "機器人權杖",
      discordApprovalTokenHintHtml: "在 [Discord 開發者入口網站](https://discord.com/developers/applications) 開啟你的應用程式 → Bot → Reset/Copy Token。不需要任何特權 Intent。",
      discordApprovalTokenPlaceholder: "貼上機器人權杖",
      discordApprovalReplaceToken: "貼上新權杖以取代",
      discordApprovalSaveToken: "儲存權杖",
      discordApprovalSaving: "儲存中…",
      discordApprovalTokenSavedPrefix: "已儲存：",
      discordApprovalInvalidToken: "這看起來不是有效的 Discord 機器人權杖。",
      discordApprovalTokenSaved: "Discord 機器人權杖已儲存。",
      discordApprovalIdsSectionTitle: "擁有者與頻道",
      discordApprovalOwnerLabel: "你的 Discord 使用者 ID",
      discordApprovalOwnerHint: "開啟開發者模式（設定 → 進階），然後右鍵你的名稱 → 複製使用者 ID。只有該使用者可以核准。",
      discordApprovalOwnerPlaceholder: "例如 123456789012345678",
      discordApprovalChannelLabel: "備援頻道 ID（選填）",
      discordApprovalChannelHint: "僅當你的私訊關閉時使用。右鍵一個私人頻道 → 複製頻道 ID。",
      discordApprovalChannelPlaceholder: "例如 123456789012345678",
      discordApprovalSaveIds: "儲存",
      discordApprovalInvalidOwner: "使用者 ID 必須是 17–20 位數字。",
      discordApprovalInvalidChannel: "頻道 ID 必須是 17–20 位數字。",
      discordApprovalConfigSaved: "Discord 核准設定已儲存。",
      discordApprovalActivitySectionTitle: "活動",
      discordApprovalEnableLabel: "啟用 Discord 核准",
      discordApprovalEnableDesc: "在 Clawd 執行時將權限卡片傳送到 Discord。",
      discordApprovalEnableNeedsConfig: "請先在上方儲存機器人權杖和你的使用者 ID 以啟用。",
      discordApprovalTestLabel: "傳送測試卡片",
      discordApprovalTestDesc: "傳送一張一次性核准卡片以確認送達。與任何代理請求無關。",
      discordApprovalTestButton: "傳送測試",
      discordApprovalTesting: "傳送中…",
      discordApprovalTestOk: "測試卡片已傳送——請在 Discord 中點按一個按鈕。",
      discordApprovalTestFailed: "Discord 測試失敗。",
      ...
      mobileApprovalsToggle: "行動端核准",
      mobileApprovalsToggleDesc: "允許已配對的手機核准或拒絕工具請求（允許 / 拒絕 / 建議）。關閉時手機保持唯讀。",
      mobileTranscriptToggle: "手機即時轉錄",
      mobileTranscriptToggleDesc: "將 Claude Code 對話串流至已授權的裝置。需要 HTTPS 或回環連線。",
      mobileTranscriptOutputToggle: "包含工具輸出",
      mobileTranscriptOutputToggleDesc: "同時在轉錄中傳送工具結果。關閉時僅傳送名稱與中繼資料。",
      mobileConnModeTitle: "連線方式",
      mobileConnModeDesc: "手機如何連線到此桌面。區域網路使用本地網路；Tailscale 透過你的 tailnet 路由。",
      mobileConnModeLan: "區域網路（同一網路）",
      mobileConnModeTailscale: "Tailscale",
      mobilePortTitle: "HTTP 連接埠",
      mobilePortDesc: "區域網路監控橋接的固定連接埠。保持不變，手機才能始終自動重連。",
      mobileHttpsPortTitle: "HTTPS 連接埠",
      mobileHttpsPortDesc: "iPhone 應用安裝所用的安全（wss）橋接固定連接埠。變更後需要重新配對手機。",
      mobilePortInvalid: "請輸入 1024 到 65535 之間的連接埠。",
      mobilePortBindError: "連接埠被占用",
      mobileHttpsToggle: "安全連線（HTTPS / wss）",
      mobileHttpsToggleDesc: "產生自簽憑證，讓 iOS 取得安全環境以支援 Web Push 與核准。iPhone 上的互動功能需要此項。",
      mobileHttpsStarting: "正在設定憑證…",
      mobileHttpsError: "HTTPS 設定失敗",
      mobileCertSection: "憑證信任",
      mobileCertDownload: "下載 CA 憑證",
      mobileCertInstructions: "在 iPhone 上開啟此網址下載憑證，然後安裝並信任它：設定 → 一般 → VPN 與裝置管理（安裝描述檔），再到 設定 → 一般 → 關於本機 → 憑證信任設定（開啟）。在信任 CA 之前安全連線（wss）無法使用。",
      mobileCertCaFingerprint: "CA 指紋",
      mobileCertLeafFingerprint: "伺服器指紋",
      mobileCertTrustedToggle: "我已在手機上信任該憑證",
      mobileCertTrustedDesc: "僅作記錄——安裝並信任 CA 後開啟此項以便記住已完成。",
      mobilePairTitle: "配對手機",
      mobilePairCodeInstructions: "在手機上從主畫面開啟 Clawd 應用程式 → 設定 → 配對，然後輸入此配對碼。",
      mobilePairCodeHint: "配對碼每 10 分鐘更新一次，輸入錯誤 5 次後也會更新。",
      mobilePairNewCode: "換一組碼",
      mobilePairCodeLoading: "正在載入配對碼…",
      mobilePairCodeError: "無法載入配對碼。",
      mobileInstallTitle: "安裝或連線",
      mobilePermsTitle: "手機權限",
      mobileAdvancedTitle: "連線與安全",
      mobileAdvancedDesc: "連線方式、連接埠、HTTPS 憑證和存取權杖。",
      mobileConnDetailsTitle: "連線詳情",
      mobilePairShowQr: "顯示 QR 碼",
      mobilePairHideQr: "隱藏 QR 碼",
      mobilePairLoadingQr: "正在產生 QR 碼…",
      mobilePairQrError: "無法產生 QR 碼。",
      mobilePairHostLabel: "掃描此碼（使用 clawd.local）",
      mobilePairIpLabel: "備用：原始 IP（當 clawd.local 無法解析時）",
      mobilePairHint: "用手機相機掃描以開啟應用程式，然後加入主畫面。再用上方的配對碼配對——只需輸入一次。",
      mobileDevicesTitle: "已配對裝置",
      mobileDevicesEmpty: "尚未配對裝置。在手機上輸入上方的配對碼即可配對。",
      mobileDevicesLoading: "正在載入裝置…",
      mobileDevicesError: "無法載入已配對裝置。",
      mobileDeviceLastSeen: "上次連線 {time}",
      mobileDeviceNeverSeen: "從未連線",
      mobileDeviceAllowApprovals: "允許核准",
      mobileDeviceAllowTranscript: "允許轉錄",
      mobileDeviceRevoke: "撤銷",
      mobileDeviceRevokeConfirm: "撤銷此裝置？它將被斷線，需要重新配對才能再次連線。",
      mobilePushTitle: "推播通知",
      mobilePushConfigured: "Web Push 已設定。",
      mobilePushNotConfigured: "Web Push 尚未設定。啟用安全連線（HTTPS）或行動端核准以設定推播金鑰。",
      mobilePushSubCount: "{count} 個有效訂閱",
      mobilePushError: "無法載入推播狀態。",
      aboutEasterEggToast: "\u{1F980} Coding shouldn't feel lonely. — Ruller_Lulu / 鹿鹿",
    ...
    ko: {
      ...
      sidebarDiscord: "Discord",
      discordTitle: "Discord",
      discordSubtabPresence: "활동 상태",
      discordSubtabApproval: "승인",
      ...
      sidebarDiscordApproval: "Discord 승인",
      discordApprovalTitle: "Discord 승인",
      discordApprovalSubtitle: "로컬 권한 요청을 Discord에서 승인하거나 거부합니다. 데스크톱 버블이 기본 대체 수단이며, 먼저 응답한 쪽이 우선합니다.",
      discordApprovalNoteHtml: "직접 봇 준비: [Discord 개발자 포털](https://discord.com/developers/applications)에서 봇을 만들고 아래에 토큰을 붙여넣으세요. 토큰은 저장소 밖에 보관되며 이 기기를 벗어나지 않습니다. 카드의 작업 세부 정보는 가려집니다.",
      discordApprovalTokenSectionTitle: "봇 토큰",
      discordApprovalTokenLabel: "봇 토큰",
      discordApprovalTokenHintHtml: "[Discord 개발자 포털](https://discord.com/developers/applications)에서 앱 → Bot → Reset/Copy Token. 권한 있는 인텐트는 필요하지 않습니다.",
      discordApprovalTokenPlaceholder: "봇 토큰 붙여넣기",
      discordApprovalReplaceToken: "교체하려면 새 토큰 붙여넣기",
      discordApprovalSaveToken: "토큰 저장",
      discordApprovalSaving: "저장 중…",
      discordApprovalTokenSavedPrefix: "저장됨:",
      discordApprovalInvalidToken: "유효한 Discord 봇 토큰이 아닌 것 같습니다.",
      discordApprovalTokenSaved: "Discord 봇 토큰이 저장되었습니다.",
      discordApprovalIdsSectionTitle: "소유자 및 채널",
      discordApprovalOwnerLabel: "내 Discord 사용자 ID",
      discordApprovalOwnerHint: "개발자 모드를 켜고(설정 → 고급) 이름을 마우스 오른쪽 버튼으로 클릭 → 사용자 ID 복사. 이 사용자만 승인할 수 있습니다.",
      discordApprovalOwnerPlaceholder: "예: 123456789012345678",
      discordApprovalChannelLabel: "대체 채널 ID(선택)",
      discordApprovalChannelHint: "DM이 닫혀 있을 때만 사용됩니다. 비공개 채널을 마우스 오른쪽 버튼으로 클릭 → 채널 ID 복사.",
      discordApprovalChannelPlaceholder: "예: 123456789012345678",
      discordApprovalSaveIds: "저장",
      discordApprovalInvalidOwner: "사용자 ID는 17~20자리 숫자여야 합니다.",
      discordApprovalInvalidChannel: "채널 ID는 17~20자리 숫자여야 합니다.",
      discordApprovalConfigSaved: "Discord 승인 설정이 저장되었습니다.",
      discordApprovalActivitySectionTitle: "활동",
      discordApprovalEnableLabel: "Discord 승인 사용",
      discordApprovalEnableDesc: "Clawd가 실행되는 동안 권한 카드를 Discord로 보냅니다.",
      discordApprovalEnableNeedsConfig: "사용하려면 위에서 봇 토큰과 사용자 ID를 저장하세요.",
      discordApprovalTestLabel: "테스트 카드 보내기",
      discordApprovalTestDesc: "전달을 확인하기 위해 일회성 승인 카드를 보냅니다. 어떤 에이전트 요청과도 연결되지 않습니다.",
      discordApprovalTestButton: "테스트 보내기",
      discordApprovalTesting: "보내는 중…",
      discordApprovalTestOk: "테스트 카드를 보냈습니다 — Discord에서 버튼을 누르세요.",
      discordApprovalTestFailed: "Discord 테스트에 실패했습니다.",
      ...
      mobileApprovalsToggle: "모바일 승인",
      mobileApprovalsToggleDesc: "페어링된 휴대폰이 도구 요청을 승인하거나 거부할 수 있습니다(허용 / 거부 / 제안). 끄면 휴대폰은 읽기 전용으로 유지됩니다.",
      mobileTranscriptToggle: "휴대폰 실시간 전사",
      mobileTranscriptToggleDesc: "Claude Code 대화를 허용된 기기에 스트리밍합니다. HTTPS 또는 루프백이 필요합니다.",
      mobileTranscriptOutputToggle: "도구 출력 포함",
      mobileTranscriptOutputToggleDesc: "전사에 도구 결과도 전송합니다. 끄면 이름과 메타데이터만 전송됩니다.",
      mobileConnModeTitle: "연결 방식",
      mobileConnModeDesc: "휴대폰이 이 데스크톱에 연결하는 방법입니다. LAN은 로컬 네트워크를 사용하고, Tailscale은 tailnet으로 라우팅합니다.",
      mobileConnModeLan: "LAN(같은 네트워크)",
      mobileConnModeTailscale: "Tailscale",
      mobilePortTitle: "HTTP 포트",
      mobilePortDesc: "LAN 모니터 브리지의 고정 포트입니다. 휴대폰이 항상 다시 연결되도록 변경하지 마세요.",
      mobileHttpsPortTitle: "HTTPS 포트",
      mobileHttpsPortDesc: "iPhone 앱이 설치되는 보안(wss) 브리지의 고정 포트입니다. 변경하면 휴대폰을 다시 페어링해야 합니다.",
      mobilePortInvalid: "1024에서 65535 사이의 포트를 입력하세요.",
      mobilePortBindError: "포트 사용 중",
      mobileHttpsToggle: "보안 연결(HTTPS / wss)",
      mobileHttpsToggleDesc: "자체 서명 인증서를 생성하여 iOS가 Web Push 및 승인을 위한 보안 컨텍스트를 얻도록 합니다. iPhone의 대화형 기능에 필요합니다.",
      mobileHttpsStarting: "인증서를 설정하는 중…",
      mobileHttpsError: "HTTPS 설정 실패",
      mobileCertSection: "인증서 신뢰",
      mobileCertDownload: "CA 인증서 다운로드",
      mobileCertInstructions: "iPhone에서 이 URL을 열어 인증서를 다운로드한 다음 설치하고 신뢰하세요: 설정 → 일반 → VPN 및 기기 관리(프로파일 설치), 이어서 설정 → 일반 → 정보 → 인증서 신뢰 설정(켜기). CA를 신뢰하기 전에는 보안 연결(wss)이 작동하지 않습니다.",
      mobileCertCaFingerprint: "CA 지문",
      mobileCertLeafFingerprint: "서버 지문",
      mobileCertTrustedToggle: "휴대폰에서 인증서를 신뢰했습니다",
      mobileCertTrustedDesc: "기록용일 뿐입니다 — CA를 설치하고 신뢰한 후 이 항목을 켜서 완료되었음을 기억하세요.",
      mobilePairTitle: "휴대폰 페어링",
      mobilePairCodeInstructions: "휴대폰에서 홈 화면의 Clawd 앱을 열고 → 설정 → 페어링으로 이동한 다음 이 코드를 입력하세요.",
      mobilePairCodeHint: "코드는 10분마다, 그리고 5번 틀리면 새로 발급됩니다.",
      mobilePairNewCode: "새 코드",
      mobilePairCodeLoading: "코드 로딩 중…",
      mobilePairCodeError: "페어링 코드를 불러올 수 없습니다.",
      mobileInstallTitle: "설치 또는 연결",
      mobilePermsTitle: "휴대폰 권한",
      mobileAdvancedTitle: "연결 및 보안",
      mobileAdvancedDesc: "연결 방식, 포트, HTTPS 인증서, 액세스 토큰.",
      mobileConnDetailsTitle: "연결 정보",
      mobilePairShowQr: "QR 표시",
      mobilePairHideQr: "QR 숨기기",
      mobilePairLoadingQr: "QR 생성 중…",
      mobilePairQrError: "QR을 생성할 수 없습니다.",
      mobilePairHostLabel: "이것을 스캔하세요(clawd.local 사용)",
      mobilePairIpLabel: "대체: 원시 IP(clawd.local이 확인되지 않을 때)",
      mobilePairHint: "휴대폰 카메라로 스캔해 앱을 연 다음 홈 화면에 추가하세요. 그런 다음 위의 코드로 페어링하세요 — 한 번만 입력하면 됩니다.",
      mobileDevicesTitle: "페어링된 기기",
      mobileDevicesEmpty: "아직 페어링된 기기가 없습니다. 휴대폰에 위의 코드를 입력해 페어링하세요.",
      mobileDevicesLoading: "기기 로딩 중…",
      mobileDevicesError: "페어링된 기기를 불러올 수 없습니다.",
      mobileDeviceLastSeen: "마지막 연결 {time}",
      mobileDeviceNeverSeen: "연결된 적 없음",
      mobileDeviceAllowApprovals: "승인 허용",
      mobileDeviceAllowTranscript: "전사 허용",
      mobileDeviceRevoke: "해제",
      mobileDeviceRevokeConfirm: "이 기기를 해제하시겠습니까? 연결이 끊기며 다시 연결하려면 재페어링해야 합니다.",
      mobilePushTitle: "푸시 알림",
      mobilePushConfigured: "Web Push가 구성되었습니다.",
      mobilePushNotConfigured: "Web Push가 아직 구성되지 않았습니다. 보안 연결(HTTPS) 또는 모바일 승인을 활성화하여 푸시 키를 설정하세요.",
      mobilePushSubCount: "활성 구독 {count}개",
      mobilePushError: "푸시 상태를 불러올 수 없습니다.",
      aboutEasterEggToast: "\u{1F980} Coding shouldn't feel lonely. — Ruller_Lulu / \u9e7f\u9e7f",
    ...
    ja: {
      ...
      sidebarDiscord: "Discord",
      discordTitle: "Discord",
      discordSubtabPresence: "リッチプレゼンス",
      discordSubtabApproval: "承認",
      ...
      sidebarDiscordApproval: "Discord 承認",
      discordApprovalTitle: "Discord 承認",
      discordApprovalSubtitle: "ローカルの権限リクエストを Discord から承認または拒否します。デスクトップのバブルがフォールバックとして残り、最初に応答した方が優先されます。",
      discordApprovalNoteHtml: "自前のボットを用意：[Discord Developer Portal](https://discord.com/developers/applications) でボットを作成し、下にトークンを貼り付けてください。トークンはリポジトリの外に保存され、この端末から外に出ることはありません。カードの操作詳細はマスクされます。",
      discordApprovalTokenSectionTitle: "ボットトークン",
      discordApprovalTokenLabel: "ボットトークン",
      discordApprovalTokenHintHtml: "[Discord Developer Portal](https://discord.com/developers/applications) でアプリ → Bot → Reset/Copy Token。特権インテントは不要です。",
      discordApprovalTokenPlaceholder: "ボットトークンを貼り付け",
      discordApprovalReplaceToken: "置き換えるには新しいトークンを貼り付け",
      discordApprovalSaveToken: "トークンを保存",
      discordApprovalSaving: "保存中…",
      discordApprovalTokenSavedPrefix: "保存済み：",
      discordApprovalInvalidToken: "Discord のボットトークンではないようです。",
      discordApprovalTokenSaved: "Discord ボットトークンを保存しました。",
      discordApprovalIdsSectionTitle: "オーナーとチャンネル",
      discordApprovalOwnerLabel: "あなたの Discord ユーザー ID",
      discordApprovalOwnerHint: "開発者モードを有効にし（設定 → 詳細設定）、自分の名前を右クリック → ユーザー ID をコピー。このユーザーのみが承認できます。",
      discordApprovalOwnerPlaceholder: "例：123456789012345678",
      discordApprovalChannelLabel: "フォールバックチャンネル ID（任意）",
      discordApprovalChannelHint: "DM が閉じている場合にのみ使用します。プライベートチャンネルを右クリック → チャンネル ID をコピー。",
      discordApprovalChannelPlaceholder: "例：123456789012345678",
      discordApprovalSaveIds: "保存",
      discordApprovalInvalidOwner: "ユーザー ID は 17〜20 桁の数字である必要があります。",
      discordApprovalInvalidChannel: "チャンネル ID は 17〜20 桁の数字である必要があります。",
      discordApprovalConfigSaved: "Discord 承認の設定を保存しました。",
      discordApprovalActivitySectionTitle: "アクティビティ",
      discordApprovalEnableLabel: "Discord 承認を有効にする",
      discordApprovalEnableDesc: "Clawd の実行中に権限カードを Discord に送信します。",
      discordApprovalEnableNeedsConfig: "有効にするには、上でボットトークンとユーザー ID を保存してください。",
      discordApprovalTestLabel: "テストカードを送信",
      discordApprovalTestDesc: "配信を確認するために 1 回限りの承認カードを送信します。エージェントのリクエストとは関係ありません。",
      discordApprovalTestButton: "テスト送信",
      discordApprovalTesting: "送信中…",
      discordApprovalTestOk: "テストカードを送信しました — Discord でボタンを押してください。",
      discordApprovalTestFailed: "Discord テストに失敗しました。",
      ...
      mobileApprovalsToggle: "モバイル承認",
      mobileApprovalsToggleDesc: "ペアリング済みのスマートフォンがツール要求を承認・拒否できるようにします（許可 / 拒否 / 提案）。オフの場合、スマートフォンは読み取り専用のままです。",
      mobileTranscriptToggle: "スマートフォンにライブ文字起こし",
      mobileTranscriptToggleDesc: "Claude Code の会話を許可済みデバイスにストリーミングします。HTTPS またはループバックが必要です。",
      mobileTranscriptOutputToggle: "ツール出力を含める",
      mobileTranscriptOutputToggleDesc: "文字起こしにツール結果も送信します。オフの場合は名前とメタデータのみ送信されます。",
      mobileConnModeTitle: "接続方法",
      mobileConnModeDesc: "スマートフォンがこのデスクトップに接続する方法です。LAN はローカルネットワークを使用し、Tailscale は tailnet 経由でルーティングします。",
      mobileConnModeLan: "LAN（同一ネットワーク）",
      mobileConnModeTailscale: "Tailscale",
      mobilePortTitle: "HTTP ポート",
      mobilePortDesc: "LAN モニターブリッジの固定ポートです。スマートフォンが常に再接続できるよう、変更しないでください。",
      mobileHttpsPortTitle: "HTTPS ポート",
      mobileHttpsPortDesc: "iPhone アプリがインストールされるセキュア（wss）ブリッジの固定ポートです。変更するとスマートフォンの再ペアリングが必要です。",
      mobilePortInvalid: "1024〜65535 のポートを入力してください。",
      mobilePortBindError: "ポート使用中",
      mobileHttpsToggle: "セキュア接続（HTTPS / wss）",
      mobileHttpsToggleDesc: "自己署名証明書を生成し、iOS が Web Push と承認のためのセキュアコンテキストを得られるようにします。iPhone のインタラクティブ機能に必要です。",
      mobileHttpsStarting: "証明書を設定中…",
      mobileHttpsError: "HTTPS の設定に失敗しました",
      mobileCertSection: "証明書の信頼",
      mobileCertDownload: "CA 証明書をダウンロード",
      mobileCertInstructions: "iPhone でこの URL を開いて証明書をダウンロードし、インストールして信頼してください：設定 → 一般 → VPN とデバイス管理（プロファイルをインストール）、続いて 設定 → 一般 → 情報 → 証明書信頼設定（オンにする）。CA を信頼するまでセキュア接続（wss）は機能しません。",
      mobileCertCaFingerprint: "CA フィンガープリント",
      mobileCertLeafFingerprint: "サーバーフィンガープリント",
      mobileCertTrustedToggle: "スマートフォンで証明書を信頼しました",
      mobileCertTrustedDesc: "記録用のみ — CA をインストールして信頼したらこれをオンにして完了したことを覚えておきましょう。",
      mobilePairTitle: "スマートフォンをペアリング",
      mobilePairCodeInstructions: "スマートフォンでホーム画面の Clawd アプリを開き → 設定 → ペアリング に進み、このコードを入力してください。",
      mobilePairCodeHint: "コードは 10 分ごと、また 5 回間違えると更新されます。",
      mobilePairNewCode: "新しいコード",
      mobilePairCodeLoading: "コードを読み込み中…",
      mobilePairCodeError: "ペアリングコードを読み込めません。",
      mobileInstallTitle: "インストールまたは接続",
      mobilePermsTitle: "スマートフォンの権限",
      mobileAdvancedTitle: "接続とセキュリティ",
      mobileAdvancedDesc: "接続方式、ポート、HTTPS 証明書、アクセストークン。",
      mobileConnDetailsTitle: "接続情報",
      mobilePairShowQr: "QR を表示",
      mobilePairHideQr: "QR を非表示",
      mobilePairLoadingQr: "QR を生成中…",
      mobilePairQrError: "QR を生成できませんでした。",
      mobilePairHostLabel: "これをスキャン（clawd.local を使用）",
      mobilePairIpLabel: "フォールバック：生の IP（clawd.local が解決しない場合）",
      mobilePairHint: "スマートフォンのカメラでスキャンしてアプリを開き、ホーム画面に追加してください。その後、上のコードでペアリングします — 入力は一度だけです。",
      mobileDevicesTitle: "ペアリング済みデバイス",
      mobileDevicesEmpty: "まだペアリングされたデバイスはありません。スマートフォンに上のコードを入力してペアリングしてください。",
      mobileDevicesLoading: "デバイスを読み込み中…",
      mobileDevicesError: "ペアリング済みデバイスを読み込めません。",
      mobileDeviceLastSeen: "最終接続 {time}",
      mobileDeviceNeverSeen: "未接続",
      mobileDeviceAllowApprovals: "承認を許可",
      mobileDeviceAllowTranscript: "文字起こしを許可",
      mobileDeviceRevoke: "取り消し",
      mobileDeviceRevokeConfirm: "このデバイスを取り消しますか？切断され、再接続するには再ペアリングが必要です。",
      mobilePushTitle: "プッシュ通知",
      mobilePushConfigured: "Web Push が設定されています。",
      mobilePushNotConfigured: "Web Push はまだ設定されていません。セキュア接続（HTTPS）またはモバイル承認を有効にしてプッシュキーを設定してください。",
      mobilePushSubCount: "有効なサブスクリプション {count} 件",
      mobilePushError: "プッシュ状態を読み込めません。",
      aboutEasterEggToast: "\u{1F980} Coding shouldn't feel lonely. — Ruller_Lulu / 鹿鹿",
