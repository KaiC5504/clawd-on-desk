...
(function initSettingsI18n(root) {
  const STRINGS = {
    en: {
      ...
      mobilePairShowQr: "Show pairing QR",
      mobilePairHideQr: "Hide pairing QR",
      mobilePairLoadingQr: "Generating QR…",
      mobilePairQrError: "Couldn't generate the pairing QR.",
      mobilePairHostLabel: "Scan this (uses clawd.local)",
      mobilePairIpLabel: "Fallback: raw IP (if clawd.local doesn't resolve)",
      mobilePairHint: "Scan with your phone's camera. After it connects, the phone pairs itself and remembers this desktop — you only do this once.",
      mobileDevicesTitle: "Paired devices",
      mobileDevicesEmpty: "No devices paired yet. Use the QR above to pair your phone.",
    ...
    zh: {
      ...
      mobilePairShowQr: "显示配对二维码",
      mobilePairHideQr: "隐藏配对二维码",
      mobilePairLoadingQr: "正在生成二维码…",
      mobilePairQrError: "无法生成配对二维码。",
      mobilePairHostLabel: "扫描此码（使用 clawd.local）",
      mobilePairIpLabel: "备用：原始 IP（当 clawd.local 无法解析时）",
      mobilePairHint: "用手机相机扫描。连接后手机会自动配对并记住此桌面——只需操作一次。",
      mobileDevicesTitle: "已配对设备",
      mobileDevicesEmpty: "尚未配对设备。使用上方二维码配对你的手机。",
    ...
    "zh-TW": {
      ...
      mobilePairShowQr: "顯示配對 QR 碼",
      mobilePairHideQr: "隱藏配對 QR 碼",
      mobilePairLoadingQr: "正在產生 QR 碼…",
      mobilePairQrError: "無法產生配對 QR 碼。",
      mobilePairHostLabel: "掃描此碼（使用 clawd.local）",
      mobilePairIpLabel: "備用：原始 IP（當 clawd.local 無法解析時）",
      mobilePairHint: "用手機相機掃描。連線後手機會自動配對並記住此桌面——只需操作一次。",
      mobileDevicesTitle: "已配對裝置",
      mobileDevicesEmpty: "尚未配對裝置。使用上方 QR 碼配對你的手機。",
    ...
    ko: {
      ...
      mobilePairShowQr: "페어링 QR 표시",
      mobilePairHideQr: "페어링 QR 숨기기",
      mobilePairLoadingQr: "QR 생성 중…",
      mobilePairQrError: "페어링 QR을 생성할 수 없습니다.",
      mobilePairHostLabel: "이것을 스캔하세요(clawd.local 사용)",
      mobilePairIpLabel: "대체: 원시 IP(clawd.local이 확인되지 않을 때)",
      mobilePairHint: "휴대폰 카메라로 스캔하세요. 연결되면 휴대폰이 스스로 페어링하고 이 데스크톱을 기억합니다 — 한 번만 하면 됩니다.",
      mobileDevicesTitle: "페어링된 기기",
      mobileDevicesEmpty: "아직 페어링된 기기가 없습니다. 위의 QR로 휴대폰을 페어링하세요.",
    ...
    ja: {
      ...
      mobilePairShowQr: "ペアリング QR を表示",
      mobilePairHideQr: "ペアリング QR を非表示",
      mobilePairLoadingQr: "QR を生成中…",
      mobilePairQrError: "ペアリング QR を生成できませんでした。",
      mobilePairHostLabel: "これをスキャン（clawd.local を使用）",
      mobilePairIpLabel: "フォールバック：生の IP（clawd.local が解決しない場合）",
      mobilePairHint: "スマートフォンのカメラでスキャンしてください。接続後、スマートフォンは自分でペアリングしこのデスクトップを記憶します — 一度だけで済みます。",
      mobileDevicesTitle: "ペアリング済みデバイス",
      mobileDevicesEmpty: "まだペアリングされたデバイスはありません。上の QR でスマートフォンをペアリングしてください。",
