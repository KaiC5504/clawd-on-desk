...
describe("server-route-permission POST", () => {
  ...
  // remote-approval seam. The seam decides per-surface whether to actually
  // dispatch (mobile PWA renders them; Telegram is filtered out) — the route no
  // longer blocks them up front.
  it("forwards ExitPlanMode and AskUserQuestion to the remote-approval seam", async () => {
    const cases = [
