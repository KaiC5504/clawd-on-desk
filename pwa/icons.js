/* Clawd SVG Icons — Lucide-style stroke-based, 24x24, 2px stroke, round caps */
var ICONS = {
  /* ── State icons ── */
  ...
  juggling: '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="7" width="20" height="3" rx="1"/><rect x="2" y="14" width="20" height="3" rx="1"/><circle cx="7" cy="5" r="1.5" fill="currentColor"/><circle cx="17" cy="19" r="1.5" fill="currentColor"/><circle cx="12" cy="5" r="1.5" fill="currentColor"/></svg>',
  ...
  notification: '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9"/><path d="M13.73 21a2 2 0 0 1-3.46 0"/></svg>',

  sweeping: '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 21c1.5-1.5 3-2 7-2s5.5.5 7 2"/><path d="M12 14l-3-3"/><path d="M14.5 11.5L12 14"/><path d="M12 14l3-3"/><path d="M9.5 11.5L12 14"/><path d="M12 3v2"/><path d="M4.93 4.93l1.41 1.41"/><path d="M20 12h-2"/><path d="M19.07 4.93l-1.41 1.41"/><path d="M12 5a7 7 0 0 1 7 7"/></svg>',

  carrying: '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"/><polyline points="3.27 6.96 12 12.01 20.73 6.96"/><line x1="12" y1="22.08" x2="12" y2="12"/></svg>',

  idle: '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"/></svg>',

  sleeping: '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M2 12h4l2-4 3 8 3-6 2 4h4"/><path d="M4 20h16"/></svg>',
  ...
  paw: '<svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="4" r="2"/><circle cx="18" cy="8" r="2"/><circle cx="4" cy="8" r="2"/><path d="M7 16c0 0 1.5 4 4 4s4-4 4-4"/><circle cx="7.5" cy="12" r="1.5"/><circle cx="14.5" cy="12" r="1.5"/></svg>',

  expand: '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="6 9 12 15 18 9"/></svg>',

  collapse: '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="18 15 12 9 6 15"/></svg>',
  ...
  square: '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="5" y="5" width="14" height="14" rx="2"/></svg>',
  ...
  split: '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="6" y1="3" x2="6" y2="15"/><circle cx="18" cy="6" r="3"/><circle cx="6" cy="18" r="3"/><path d="M18 9a9 9 0 0 1-9 9"/></svg>',
  ...
  dot: '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="3" fill="currentColor"/></svg>',
};
...
/* Hook event -> icon name (resolved against ICONS by app.js's eventIcon).
   Kept as names, never glyphs, so the timeline stays monochrome and themeable. */
var EVENT_ICONS = {
  UserPromptSubmit: "messageCircle", PreToolUse: "tool", PostToolUse: "check",
  PostToolUseFailure: "x", Stop: "flag", StopFailure: "x",
  SessionStart: "play", SessionEnd: "square",
  PermissionRequest: "shield", Notification: "bell",
  SubagentStart: "split", SubagentStop: "split",
  AfterAgent: "check", ApiError: "error",
  Elicitation: "helpCircle", WorktreeCreate: "gitFork",
};

if (typeof module !== "undefined" && module.exports) {
  module.exports = { ICONS: ICONS, EVENT_LABELS: EVENT_LABELS, EVENT_ICONS: EVENT_ICONS };
}
