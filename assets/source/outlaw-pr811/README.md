...
These files preserve the source material contributed by GitHub user
`anthonyonazure` in [PR #811](https://github.com/rullerzhou-afk/clawd-on-desk/pull/811)
...
- `clawd-outlaw-bender.svg` is the unmodified author-provided 15-second bender
  ...
  on Electron's document-backed channel, because `<img>` does not advance the
  embedded SVG timeline.
